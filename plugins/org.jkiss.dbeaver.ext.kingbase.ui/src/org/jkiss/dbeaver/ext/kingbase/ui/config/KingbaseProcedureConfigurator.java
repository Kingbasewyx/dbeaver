...
public class KingbaseProcedureConfigurator implements DBEObjectConfigurator<KingbaseProcedure> {
    ...
    @Override
    public KingbaseProcedure configureObject(DBRProgressMonitor monitor, DBECommandContext commandContext, Object container,
    		KingbaseProcedure newProcedure, Map<String, Object> options) {
