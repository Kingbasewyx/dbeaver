...
public class KingbaseFunctionConfigurator implements DBEObjectConfigurator<KingbaseFunction> {
    ...
    @Override
    public KingbaseFunction configureObject(DBRProgressMonitor monitor, DBECommandContext commandContext, Object container,
    		KingbaseFunction newProcedure, Map<String, Object> options) {
