 ...
 */
public class KingbaseDatabaseManager extends SQLObjectEditor<KingbaseDatabase, KingbaseDataSource>
    implements DBEObjectRenamer<KingbaseDatabase> {
    ...
    @Override
    public DBSObjectCache<? extends DBSObject, KingbaseDatabase> getObjectsCache(KingbaseDatabase object) {
        // TODO Auto-generated method stub
        return null;
    }

    @Override
    public void deleteObject(@NotNull DBECommandContext commandContext, @NotNull KingbaseDatabase object, @NotNull Map<String, Object> options)
        throws DBException {
    ...
    @Override
    public void renameObject(@NotNull DBECommandContext commandContext, @NotNull KingbaseDatabase database,
    ...
    protected void addObjectExtraActions(@NotNull DBRProgressMonitor monitor, @NotNull DBCExecutionContext executionContext,
                                         @NotNull List<DBEPersistAction> actions, @NotNull NestedObjectCommand<KingbaseDatabase, PropertyHandler> command, @NotNull Map<String, Object> options)
        throws DBException {
    ...
    @Override
    protected KingbaseDatabase createDatabaseObject(@NotNull DBRProgressMonitor monitor, @NotNull DBECommandContext context, Object container,
                                                   Object copyFrom, @NotNull Map<String, Object> options) throws DBException {
        return ((KingbaseDataSource) container).createDatabaseImpl(monitor, "NewDatabase", null, null, null, null);
    }
    ...
    protected void addObjectCreateActions(@NotNull DBRProgressMonitor monitor, @NotNull DBCExecutionContext executionContext,
        ...
        final KingbaseDatabase database = command.getObject();
